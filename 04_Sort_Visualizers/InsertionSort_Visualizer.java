...
public class InsertionSort_Visualizer extends JPanel {
    /**
	 * 
	 */
    ...
    public InsertionSort_Visualizer(int[] array, int delay) {
        this.array = array;
    ...
    public void visualizeSort() {
        new Thread(() -> {
            insertionSort();  // Call the non-static method that uses the instance array
        }).start();
    }
    ...
    private void insertionSort() {
        for (int i = 1; i < array.length; ++i) {
            ...
            repaint();  // Redraw the panel after every change
    ...
    public static void main(String[] args) {
        ...
        InsertionSort_Visualizer visualizer = new InsertionSort_Visualizer(array, 50);
